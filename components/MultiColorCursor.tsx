...
const RAINBOW_COLORS = ["#FF6B6B", "#00C2FF", "#51CF66", "#00C2FF", "#845EF7", "#F06292"];
  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-[999999] overflow-hidden">
      ...
      <motion.div
        ...
        style-custom={{
          background:
            "linear-gradient(#00000000, #00000000) padding-box, linear-gradient(135deg, #FF6B6B, #00C2FF, #51CF66, #00C2FF, #845EF7, #F06292) border-box",
        }}
      >
        <div
          ...
          style={{
            ...
            background:
              "linear-gradient(#00000000, #00000000) padding-box, linear-gradient(135deg, #FF6B6B, #00C2FF, #51CF66, #00C2FF, #845EF7, #F06292) border-box",
            boxShadow: isHovered
              ? "0 0 22px rgba(0, 163, 224, 0.6), 0 0 10px rgba(0, 194, 255, 0.5)"
      ...
      <motion.div
        ...
        style-custom={{
          background:
            "linear-gradient(135deg, #FF6B6B 0%, #00C2FF 35%, #00C2FF 70%, #845EF7 100%)",
        }}
      >
        <div
