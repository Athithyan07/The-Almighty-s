...
export function LiquidMeshBackground() {
  ...
  const [isMobile, setIsMobile] = useState(true); // default true to avoid SSR mismatch
  ...
  useEffect(() => {
    ...
    if (mobile) return; // skip mouse tracking entirely on mobile
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-[-1] overflow-hidden">
      ...
      {/* Orbs — hidden on mobile via CSS, no JS needed */}
      {!isMobile && (
        <>
          {/* Orb 1: Primary Yellow Gold */}
          <div
          ...
          {/* Interactive cursor-responsive ambient highlight */}
          <div
            ...
            style={{
              ...
              backgroundColor: isDark ? "rgba(168, 85, 247, 0.18)" : "rgba(216, 180, 254, 0.28)",
            }}
          />
        </>
      )}
