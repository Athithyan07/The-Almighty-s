        ...
        >
          ...
          <div className="absolute inset-0 -z-10 pointer-events-none">
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(ellipse 85% 85% at 50% 50%, rgba(9,9,13,0.45) 0%, rgba(9,9,13,0.85) 100%)",
              }}
            />
          </div>
          ...
          {!isFirstVisit ? (
            ...
            >
              ...
              <span className="luxury-overline text-xs font-bold tracking-[0.25em] text-[#C9A84C]">
                Entering Campus...
              </span>
            </motion.div>
          ) : (
            ...
            >
              ...
              {/* Heading */}
              <span className="luxury-overline text-[0.68rem] sm:text-xs font-bold tracking-[0.25em] text-[#C9A84C] mb-1.5">
                Welcome To
              </span>
              <h1
              ...
              >
                The Almighty&apos;s
                <br />
                <em className="text-[#C9A84C] italic">Matriculation School</em>
              </h1>
              ...
              <div className="mt-7 w-full flex flex-col items-center">
                {!isReady ? (
                  <div className="w-full max-w-[280px]">
                    <div className="flex items-center justify-between text-xs mb-2 font-mono font-bold text-[#C9A84C]">
                  ...
                  >
                    <button
                      onClick={handleEnter}
                      id="enter-site-btn"
                      className="liquid-glass-button group inline-flex items-center gap-3 px-8 py-3.5 rounded-full text-xs sm:text-sm font-bold uppercase tracking-widest text-white border border-amber-400/60 bg-gradient-to-r from-amber-500/30 via-yellow-400/25 to-amber-600/30 shadow-[0_0_30px_rgba(201,168,76,0.4)] backdrop-blur-lg hover:scale-105 active:scale-95 transition-all cursor-pointer"
                    >
                      <span>Enter The Almighty&apos;s</span>
                      <ArrowRight className="w-4 h-4 text-[#C9A84C] group-hover:translate-x-1.5 transition-transform" />
                    </button>
                  </motion.div>
                )}
              </div>
