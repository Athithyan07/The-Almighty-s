...
export default function AchievementsPage() {
  return (
    <div className="w-full overflow-x-hidden">
      ...
      <section className="relative pt-24 pb-14 sm:pt-28 sm:pb-24 px-4 sm:px-8 lg:px-12 text-center overflow-hidden">
        ...
        <Scroll3DReveal direction="up" className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="mt-8 sm:mt-10 grid grid-cols-2 sm:grid-cols-4 gap-2.5 sm:gap-4 max-w-3xl mx-auto">
              <div
                className="p-3.5 sm:p-5 rounded-2xl flex flex-col items-center justify-center gap-1 backdrop-blur-[5px] bg-white/40 dark:bg-black/30 border border-neutral-300/60 dark:border-white/15"
              >
                <div className="luxury-stat-num text-[#C9A84C]" style={{ fontSize: "clamp(1.6rem, 5vw, 2.4rem)" }}>100%</div>
                <div className="text-[11px] sm:text-xs font-bold uppercase tracking-wider text-neutral-800 dark:text-neutral-300">
                  Board Pass Rate
                </div>
              </div>
              ...
              <div
                className="p-3.5 sm:p-5 rounded-2xl flex flex-col items-center justify-center gap-1 backdrop-blur-[5px] bg-white/40 dark:bg-black/30 border border-neutral-300/60 dark:border-white/15"
              >
                <div className="luxury-stat-num text-[#C9A84C]" style={{ fontSize: "clamp(1.6rem, 5vw, 2.4rem)" }}>48+</div>
                <div className="text-[11px] sm:text-xs font-bold uppercase tracking-wider text-neutral-800 dark:text-neutral-300">
                  State Trophies
                </div>
              </div>
              ...
              <div
                className="p-3.5 sm:p-5 rounded-2xl flex flex-col items-center justify-center gap-1 backdrop-blur-[5px] bg-white/40 dark:bg-black/30 border border-neutral-300/60 dark:border-white/15"
              >
                <div className="luxury-stat-num text-[#C9A84C]" style={{ fontSize: "clamp(1.6rem, 5vw, 2.4rem)" }}>22</div>
                <div className="text-[11px] sm:text-xs font-bold uppercase tracking-wider text-neutral-800 dark:text-neutral-300">
                  Olympiad Golds
                </div>
              </div>
              ...
              <div
                className="p-3.5 sm:p-5 rounded-2xl flex flex-col items-center justify-center gap-1 backdrop-blur-[5px] bg-white/40 dark:bg-black/30 border border-neutral-300/60 dark:border-white/15"
              >
                <div className="luxury-stat-num text-[#C9A84C]" style={{ fontSize: "clamp(1.6rem, 5vw, 2.4rem)" }}>#1</div>
                <div className="text-[11px] sm:text-xs font-bold uppercase tracking-wider text-neutral-800 dark:text-neutral-300">
                  District Shield
                </div>
              </div>
      ...
      {/* ══ TIMELINE SECTION ══ */}
      <section
        className="relative py-14 sm:py-20 px-3 sm:px-8 lg:px-12 overflow-hidden bg-[#FAF8F5] dark:bg-[#09090d] animated-line-pattern border-y border-amber-600/15 dark:border-amber-400/15"
      >
